...
This roadmap is product-facing and may change as the platform evolves.
...
- Improve one-click strategy startup and stop-and-close workflows.
- Add clearer risk warnings and position-drift summaries.
...
- Improve invite flow.
- Add clearer referral reward status.
- Add more founder and product showcase material.
- Add public-facing product docs.
- Add case studies and strategy writeups.
