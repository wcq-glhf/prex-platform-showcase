...
[Live product](https://prex.best) · [Demo video](https://drive.google.com/file/d/18hOAWbHKjNPVI5ON2luKm4YQ1UTeMpHG/view?usp=drive_link) · [PREX Strategy MCP](https://prex.best/api/mcp) · [Submission repository](https://github.com/wcq-glhf/prex-platform-showcase/tree/main/hackathons/binance-agent-os) · [中文说明](README.zh-CN.md)
...
- Demo video: [Watch on Google Drive](https://drive.google.com/file/d/18hOAWbHKjNPVI5ON2luKm4YQ1UTeMpHG/view?usp=drive_link)
